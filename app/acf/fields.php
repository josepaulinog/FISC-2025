...
acf_add_local_field_group(array(
	...
	'fields' => array(
		// Basic Details
		array(
			'key' => 'field_attendee_full_name',
			'label' => 'Full Name',
			'name' => 'full_name',
			'type' => 'text',
			'instructions' => 'Enter the full name of the attendee or delegate.',
			'required' => 1,
		),
		array(
			'key' => 'field_attendee_job_title',
			'label' => 'Job Title',
			'name' => 'job_title',
			'type' => 'text',
			'instructions' => 'Enter their current job title.',
			'required' => 1,
		),
		array(
			'key' => 'field_attendee_organization',
			'label' => 'Organization',
			'name' => 'organization',
			'type' => 'text',
			'instructions' => 'Enter the organization they represent.',
			'required' => 1,
		),
		array(
			'key' => 'field_attendee_country',
			'label' => 'Country',
			'name' => 'country',
			'type' => 'select',
			'instructions' => 'Select their country of origin.',
			'choices' => array(
				'USA' => 'United States',
				'CAN' => 'Canada',
				'GBR' => 'United Kingdom',
		...
		array(
			...
			'name' => 'email_address',
			'type' => 'email',
			'instructions' => 'Enter their primary contact email.',
			'required' => 1,
		),
		array(
			...
			'name' => 'phone_number',
			'type' => 'text',
			'instructions' => 'Include the country code.',
			'required' => 0,
		),

		// Event Participation
		array(
			'key' => 'field_attendee_role',
			'label' => 'Event Role',
			'name' => 'event_role',
			'type' => 'select',
			'instructions' => 'Select their role in the event.',
			'choices' => array(
				'Delegate' => 'Delegate',
				'Attendee' => 'Attendee',
				'Speaker' => 'Speaker',
		...
		array(
			'key' => 'field_attendee_sessions',
			'label' => 'Sessions Attending',
			'name' => 'sessions_attending',
			'type' => 'checkbox',
			'instructions' => 'Select the sessions they are attending.',
			'choices' => array(
				'Opening Ceremony' => 'Opening Ceremony',
				'PFM Panel' => 'Public Financial Management Panel',
				'Digital Government' => 'Digital Government Innovations',
		...
		array(
			'key' => 'field_attendee_arrival_date',
			'label' => 'Arrival Date',
			'name' => 'arrival_date',
			'type' => 'date_picker',
			'instructions' => 'Enter their arrival date.',
			'required' => 0,
		),
		array(
			'key' => 'field_attendee_hotel',
			'label' => 'Hotel Name',
			'name' => 'hotel_name',
			'type' => 'text',
			'instructions' => 'Where are they staying during the event?',
			'required' => 0,
		),
		array(
			'key' => 'field_attendee_visa_required',
			'label' => 'Visa Required?',
			'name' => 'visa_required',
			'type' => 'true_false',
			'instructions' => 'Check if the attendee requires a visa.',
			'default_value' => 0,
			'ui' => 1,
		),
		...
		array(
			'key' => 'field_attendee_dietary',
			'label' => 'Dietary Restrictions',
			'name' => 'dietary_restrictions',
			'type' => 'select',
			'instructions' => 'Select any dietary restrictions.',
			'choices' => array(
				'None' => 'None',
		...
		array(
			'key' => 'field_attendee_accessibility',
			'label' => 'Accessibility Requirements',
			'name' => 'accessibility_requirements',
			'type' => 'text',
			'instructions' => 'Any specific needs (e.g., wheelchair access).',
			'required' => 0,
		),
	),
	'location' => array(
	...
	'active' => true,
	'description' => 'Fields for Attendees and Delegates at FISC 2025.',
));
