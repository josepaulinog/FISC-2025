<section class="hero min-h-[500px] relative overflow-hidden">
  ...
  <div class="relative flex items-center justify-center h-full w-full px-4 transform-gpu will-change-transform container" data-parallax="scroll" data-speed="0.1">
    <div class="text-left">
      ...
      <p class="mb-8 text-lg md:text-2xl drop-shadow text-white text-opacity-80">{{ $subtitle ?? 'April 6-10, 2025 | Dili, Timor-Leste' }}</p>
      ...
      <div>
        ...
        <a href="{{ $secondaryButtonUrl ?? '#' }}" class="btn btn-secondary text-white ml-4 group">
          {{ $secondaryButtonText }}
