            ...
            <div class="carousel w-full">
                ...
                <div id="slide-{{ $index + 1 }}" class="carousel-item relative w-full">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full px-12 md:px-12 lg:mx-4 lg:mt-3 mb-8">
                        ...
                        <div class="cursor-pointer speaker-card mx-auto max-w-sm w-full bg-white dark:bg-black/25 border dark:border-white/75 rounded-2xl shadow-lg transform lg:hover:scale-105 duration-300 ease-in-out"
