...
@section('content')
  ...
  <x-agenda 
    ...
    description="Stay informed with our detailed schedule and agenda for FISC 2025. This section provides a comprehensive rundown of all sessions  and activities from the first day to the last." 
    :days="[
