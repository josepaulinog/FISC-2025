<header class="fixed w-full z-20 transition-all duration-300 transparent-header">
  <div class="container mx-auto py-4 px-4">
    ...
    <nav class="navbar px-0" aria-label="{{ wp_get_nav_menu_name('primary_navigation') }}">
        <label 
          for="my-drawer" 
          class="btn btn-square btn-ghost lg:hidden me-5 text-white header-toggle"
      ...
      <a 
        ...
        >
        <x-logo 
              class="lg:h-12 h-10 fill-current transition-colors duration-300 font-normal text-white header-logo"
        />
      </a>

      <div class="navbar-start">
      </div>
      <div class="navbar-center hidden lg:flex text-white header-nav">
      ...
      <div class="navbar-end">
        ...
        <a 
                href="{{ home_url('/login') }}" 
                class="btn btn-ghost border-white text-white hover:bg-white hover:text-black transition-colors duration-300 login-button"
              >
                Login
